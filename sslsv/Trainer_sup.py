...
from sslsv.losses.SupContrast import SupConLoss
    ...
    def train_step_loop(self):
        ...
        for i, (x, y) in enumerate(self.train_dataloader):
            ...
            with autocast(enabled=(self.scaler is not None)):
                ...
                loss1 = self.model.module.compute_sup(x_1, y)
                loss2 = self.model.module.compute_sup(x_2, y)
                loss, metrics = self.model.module.compute_loss(loss1, loss2)
