...
from sslsv.encoders.RawNetBasicBlock import Bottle2neck, PreEmphasis


class RawNet3(nn.Module):
    def __init__(self, block, model_scale, context, summed, C=1024, nOut=256, encoder_type="ECA", **kwargs):
        super().__init__()
